...
async def login(
    ...
    redisServcie: RedisService = Depends(),
):
    ...
    await redisServcie.add_token(redis_db, access_token, req.login_id)

    return AuthResp(message="로그인 되었습니다.", user=user, access_token=access_token)
...
async def auth_logout(
    ...
    await redisServcie.delete_token(redis_db, token)
